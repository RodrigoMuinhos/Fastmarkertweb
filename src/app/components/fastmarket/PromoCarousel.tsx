        ...
        {promos.map((promo, index) => (
          <div key={index} className="px-2">
            <motion.div
              ...
              className={`bg-gradient-to-r ${promo.gradient} text-white rounded-2xl p-6 md:p-10 landscape:p-4 landscape:md:p-6 shadow-xl relative overflow-hidden h-48 md:h-64 landscape:h-32 landscape:md:h-40 flex flex-col justify-center`}
            >
