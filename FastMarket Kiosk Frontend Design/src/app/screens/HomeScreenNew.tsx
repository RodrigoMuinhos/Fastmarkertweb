...
import backgroundImage from 'figma:asset/4c08e35fafc8aa26b44ada70cd6a53b05d7e9f45.png';

export function HomeScreen() {
  const { products, setCurrentScreen, addToCart } = useFastMarket();
    ...
    <div className="min-h-screen flex flex-col relative overflow-hidden bg-gradient-to-br from-green-50 via-white to-emerald-50">
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-7xl mx-auto px-4 py-6 md:py-8 space-y-8">
          ...
          {/* Botão Principal - Começar Pedido */}
          <motion.div
          ...
          >
            <motion.button
              ...
              className="w-full bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-2xl shadow-xl py-6 md:py-8 flex items-center justify-center gap-3 relative overflow-hidden group"
            >
              <motion.div
              ...
              />
              <ShoppingCart className="w-7 h-7 md:w-8 md:h-8 relative z-10" />
              <span className="text-xl md:text-2xl font-bold relative z-10">VER TODOS OS PRODUTOS</span>
            </motion.button>
          </motion.div>
